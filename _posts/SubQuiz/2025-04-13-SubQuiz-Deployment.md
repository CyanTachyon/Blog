...
[SubQuiz](https://quiz.pkuschool.edu.cn)原为[SubIT社团](https://subit.org.cn)开发的一款智能答题系统，之后该系统将移交北大附中科技教育中心，作为北大附中学生刷题练习网站，成为北大附中信息化的一部分。

事实上目前该项目处于半社团项目的奇怪状态，理论上该项目应全权由科技教育中心负责，但目前开发由我一人完成，周边运维由北大附中科技教育中心负责，在晨曦奖学金和各项展演等活动中均作为[SubIT](https://subit.org.cn)的项目进行宣传。

项目目前前后端均完全开源，[后端](https://github.com/CyanTachyon/SubQuiz)、[前端](https://github.com/CyanTachyon/SubQuizUI)。

> 以下为2.0版本时期介绍和部署文档，已过时，当前最新大版本为3，该文档大体仍可参考，但某些细节已过时。暂无更新计划。
{: .prompt-warning }
