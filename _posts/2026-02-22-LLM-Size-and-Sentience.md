...
> 附：
>
> - 感性：在这泛指包括「情绪」「共情」「感受」「理解」「通人性」等能力。所有的对「感性」能力的评估，都是基于网络上大家的主观感受。这可能有一些不准确，但问题在于其难以量化。
...
对于其他因素，例如后训练、数据集等对于模型的影响，我现在确实难以证明他们的影响不如模型尺寸。但，从统计学来看，把「模型尺寸」「模型训练」「数据集」和「感性能力」作为随机变量，观察它们之间的相关性。可以看到，不同厂商不同时间推出的模型，他们的数据集、训练方式、RL的目标都有差异。但这种差异并没有带来显著的「感性能力」差异。相反，模型尺寸的差异却带来了显著的「感性能力」差异。这说明，模型尺寸与「感性能力」之间的相关性要远大于其他因素与「感性能力」之间的相关性了。这有可能只是巧合吗？确实，从统计学来看，它确实可能是巧合，但概率太小了。我们应当倾向于相信，模型尺寸与「感性能力」之间，就是存在相关性的。

事实上我的第二种猜测，也就是认为这种训练影响了感性能力。

因此，当前主要还是猜测，我个人猜测，模型尺寸对于「感性」能力的影响，可能是远超其他因素的了。
